...
| Encryption                                   | Encrypt plaintext using supplied key and algorithm specification  | AES mode: XTS CAVP Cert. #A2792                          | AES keys: 128-bit, 256-bit          | Crypto Officer | WEZ                                 | Return values indicate success or error     |
...
| Decryption                                   | Decrypt ciphertext using supplied key and algorithm specification | AES mode: XTS CAVP Cert. #A2792                          | AES keys: 128-bit, 256-bit          | Crypto Officer | WEZ                                 | Return values indicate success or error     |
